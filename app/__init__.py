    ...
    def inject_menu():
        ...
        if _kurum_tipi == 'surucu_kursu' and current_user.is_authenticated:
            ...
            surucu_menu_full = [
                ...
                {'label': 'Dönemler', 'icon': 'bi-calendar3',
                 'url': '/surucu-kursu/donem/',
                 'modul_key': 'surucu_kursiyer',
                 'children': [], 'renk_kat': 'mavi'},
                ...
                {'label': 'Yönlendirmeler', 'icon': 'bi-arrow-up-right-square',
                 ...
                 'children': [
                    {'label': 'Bizim Gönderdiklerimiz (Gelir)',
                     'icon': 'bi-arrow-up-right',
                     'url': '/surucu-kursu/yonlendirmeler'},
                    {'label': 'Bize Gelenler (Komisyon Gideri)',
                     'icon': 'bi-arrow-down-left',
                     'url': '/surucu-kursu/komisyon/'},
                 ], 'renk_kat': 'sari'},
                {'label': 'Makbuzlar', 'icon': 'bi-receipt',
                 'url': '/surucu-kursu/makbuz',
                 'modul_key': 'surucu_kursiyer',
                 'children': [], 'renk_kat': 'yesil'},
